...
export const uploadImage = async (file: File, folder: string = 'oficinas'): Promise<string | null> => {
  try {
...
export const uploadMultipleImages = async (files: File[], folder: string = 'oficinas'): Promise<string[]> => {
  const urls: string[] = [];
