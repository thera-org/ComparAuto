...
export default function AjudaPage() {
  ...
  const [form, setForm] = useState({ nome: '', email: '', mensagem: '', assunto: 'geral', file: null as File | null })
        ...
        <div className="mx-auto max-w-7xl px-4 py-10">
          ...
          <div className="mb-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="rounded-xl bg-white p-6 text-center shadow-md">
              ...
              <div className="text-3xl font-bold text-gray-900">{TOPICOS.reduce((acc, t) => acc + t.faqs.length, 0)}</div>
          ...
          <div className="mb-12 space-y-6">
            {filteredTopics.length === 0 ? (
              ...
              filteredTopics.map((topico, idx) => {
                ...
                return (
                  <div key={idx} className="overflow-hidden rounded-2xl bg-white shadow-lg transition hover:shadow-xl">
                    <button
          ...
          {/* Contact Channels */}
          <div className="mb-12">
            <h2 className="mb-6 text-center text-3xl font-bold text-gray-900">Outros Canais de Atendimento</h2>
