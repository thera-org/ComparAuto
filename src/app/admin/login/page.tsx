    ...
    <div className={styles.adminLoginContainer}>
      <form onSubmit={handleSubmit} className={styles.adminForm}>
        <div className={styles.adminHeader}>
          ...
          <span className={styles.subtitle}>Acesso restrito ao painel administrativo</span>
        </div>
        <div className={styles.inputGroup}>
          ...
          />
          {attempts > 0 && (
            <div className="mt-2 text-sm text-red-500">Tentativas restantes: {3 - attempts}</div>
          )}
        </div>
        <button type="submit" className={styles.submitButton} disabled={loading || isBlocked}>
          {loading ? (
